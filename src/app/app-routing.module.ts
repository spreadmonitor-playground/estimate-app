...
const routes: Routes = [
  ...
  {
    path: 'estimations/selector',
    loadChildren: './views/estimation-selector/estimation-selector.module#EstimationSelectorViewModule',
  },
  {
    path: 'estimations/summary',
    loadChildren: './views/estimation-summary/estimation-summary.module#EstimationSummaryViewModule',
  },
];
